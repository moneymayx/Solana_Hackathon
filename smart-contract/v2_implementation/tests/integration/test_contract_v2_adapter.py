...
from smart_contract.v2_implementation.backend.api.contract_adapter_v2 import (
    ContractAdapterV2,
...
class TestContractAdapterV2FeatureFlag:
    ...
    def test_feature_flag_when_enabled(self):
        ...
        import importlib
        import smart_contract.v2_implementation.backend.api.contract_adapter_v2 as contract_adapter_module
        importlib.reload(contract_adapter_module)
        
        # This would initialize if env var is set, but we're testing flag behavior
        assert contract_adapter_module.USE_CONTRACT_V2 or not os.getenv("USE_CONTRACT_V2")
...
class TestContractAdapterV2Methods:
    ...
    async def test_process_entry_payment_v2_raises_when_disabled(self):
        ...
        if not contract_adapter_module.USE_CONTRACT_V2:
            adapter = contract_adapter_module.ContractAdapterV2()
