...
export default function ReferralFlow({ onSuccess, onCancel }: ReferralFlowProps) {
  ...
  const shareReferralCode = () => {
    if (referralCode) {
      const shareText = `Join me on Billions Bounty! Use my referral code: ${referralCode} to get 5 free questions!`
      if (navigator.share) {
        navigator.share({
          title: 'Billions Bounty Referral',
          text: shareText,
  ...
  return (
    <div>
      <div className="text-center mb-6">
        ...
        <p className="text-slate-600">Enter your email to get a referral code. Share it with friends to earn 5 free questions for each person who uses it!</p>
      </div>
